...
@router.get("/posts", response_model=list[src.schemas.post_schema.PostFetchAllPosts], status_code=fastapi.status.HTTP_200_OK)
...
@router.get("/posts/{post_id}", response_model=src.schemas.post_schema.PostFetchOnePost, status_code=fastapi.status.HTTP_200_OK)
...
@router.post("/posts/create-post", status_code=fastapi.status.HTTP_201_CREATED)
