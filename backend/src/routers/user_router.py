...
@router.get("/users/{user_id}/received-sightings/unread", response_model=src.schemas.user_schema.UserUnreadSightingsCount, status_code=fastapi.status.HTTP_200_OK)
...
@router.get("/users/{user_id}/created-sightings", response_model=list[src.schemas.user_schema.UserCreatedSightings], status_code=fastapi.status.HTTP_200_OK)
...
@router.get("/users/{user_id}/posts", response_model=list[src.schemas.post_schema.PostFetchUserPosts], status_code=fastapi.status.HTTP_200_OK)
...
@router.put("/users/{user_id}/posts/{post_id}", status_code=fastapi.status.HTTP_200_OK)
...
@router.delete("/users/{user_id}/posts/{post_id}", status_code=fastapi.status.HTTP_200_OK)
...
@router.delete("/users/{user_id}/sightings/{sighting_id}", status_code=fastapi.status.HTTP_200_OK)
