    ...
    <PaperProvider>
      <Stack>
        <Stack.Protected guard={true}>
          ...
          <Stack.Screen name="(map)/[id]/new-sighting" options={{ headerShown: true, title: "New sighting", headerBackTitle: "Cancel" }}/>
          ...
          <Stack.Screen name="(posts)/[id]/index" options={{ headerShown: true, title: "View post", headerBackTitle: "Back" }}/>
          <Stack.Screen name="(posts)/[id]/edit-post" options={{ headerShown: true, title: "Edit post", headerBackTitle: "Cancel" }}/>
        </Stack.Protected>
